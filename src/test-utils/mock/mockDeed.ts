...
type ThisDeed<T extends Extras> = (deed: Deed) => MockDeed<T>;
type WithExtras<T extends Extras> = (extras: T) => MockDeed<T>;
type WithArgs<T extends Extras> = (...args: ArgsType) => MockDeed<T>;
